...
/// Measures the two states Swarm actually spends its day in: somebody typing, and an agent
/// writing.
///
...
/// handler, at a fixed rate. Not a real agent: `SWARM_UI_LIVE` costs money, a model's pace is not
/// repeatable, and what is being measured is what Swarm does with a delta rather than how fast one
...
///
///     Swarm --stream-probe /tmp/stream.json --stream-workspace <id>
