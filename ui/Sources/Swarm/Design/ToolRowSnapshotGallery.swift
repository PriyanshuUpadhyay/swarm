...
struct ToolRowSnapshotGallery: View {
    ...
    private static let worktree = "/Users/you/swarm/workspaces/there-there/hibiki-sea"
        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            group("Where a command ran") {
                ...
                row("c3", "Bash", [
                    ...
                    "command": .string("cd /Users/you/swarm/workspaces/swarm/main && git log --oneline -5"),
                ])
                row("c4", "Bash", [
