...
/// size setting cannot be an environment value SwiftUI already honours; it has to be one Swarm
/// resolves for itself.
///
...
struct ScaledFont: Hashable, Sendable {
    ...
    /// size. An unscaled Swarm therefore renders exactly what it rendered before this existed:
