...
/// The controls Swarm does not draw, drawn.
///
///     Swarm --snapshot-gallery <dir> --gallery system-accent
///
/// Every other page in this folder photographs something in `Sources/Swarm`. This one photographs
/// AppKit beside Swarm's custom interactive surfaces. Both now resolve through
/// `controlAccentColor`: the bundle accent supplies Swarm's default under Multicolour, and an
