...
/// through a swarm of light. It reads as a git history and as water at the same time, because a
...
/// gesture any app could make; this is Swarm's own picture, and it earns the extra complexity by
...
/// breathes in place. Seven fifty eight point swarms travel along their curves at between twenty
...
/// eight thousand pixels by more than eight levels in that one step, because a swarm whose alpha
...
final class BrandBranchingView: NSView {
    ...
    /// because a long one at speed stops reading as a swarm being carried and starts reading as a
    ...
    /// keeps it a swarm rather than a disc.
    ...
    /// The swarm that rides on the head of a branch.
    ///
