...
/// The dialog Swarm asks a yes-or-no question in, drawn by Swarm rather than by AppKit.
///
...
struct ConfirmationSheet: View {
    ...
    var body: some View {
        ...
        // captures against Swarm's own surfaces: in light it comes out a neutral grey a step
    ...
    ///
    /// The system's `.bordered` button with the tone painted on, rather than a control of Swarm's
    ...
    // then inside Swarm itself, on the real merge confirmation, against a `gh` that logged what
