...
struct PanelTabs<Tab: Hashable>: View {
    ...
    /// and measures 3.95 to 1, while `Palette.textTertiary` is Swarm's own retuned rung at 4.52.
    /// The system's second rung is below Swarm's third, and its own doc comment says as much.
    ///
