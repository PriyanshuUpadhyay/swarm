...
struct StartProjectView: View {
    ...
    /// The line, exactly as typed. A name, or a path, and Swarm reads which.
    ...
    var body: some View {
        ...
        // worth saying once, which is why it moves rather than goes: "Setting up swarm" is what
        ...
        .onDisappear {
            ...
            // point: `NewProjectStarter.discard` takes back what Swarm made and leaves what it
    ...
    private var footer: some View {
        HStack(spacing: Metrics.spacingWide) {
            ...
            case .naming:
                ...
                // reads as Swarm not having understood the target rather than as it refusing one.
    ...
    /// hung `git commit` really does go away. What Swarm made is then taken back off the disk, and
    ...
    ///
    /// **The hand-off is the branch the footer names.** A project Swarm made ends in the create
...
/// it hands back goes into the sidebar, and only one that Swarm made goes straight on to its first
