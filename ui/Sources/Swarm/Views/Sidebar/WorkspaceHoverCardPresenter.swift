...
final class WorkspaceHoverCardPresenter {
    ...
    private func watchForDismissal() {
        ...
        // Local, not global: this only has to know about events going to Swarm, and a global
        // monitor is a request for the accessibility permission that Swarm has no other reason to
