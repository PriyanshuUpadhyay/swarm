...
/// a machine's, are all `SwarmNotice` in the core, where they are tested. What is left here is the
/// drawing and the pointer.
struct NoticeBanner: View {
    let notice: SwarmNotice
    let onDismiss: () -> Void
    ...
    /// matters, which is what Swarm did, was the same weight as the part that explains it. The
