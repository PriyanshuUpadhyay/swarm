...
/// Turns text selected in any other app into a Swarm workspace, through the system Services menu.
///
...
/// arrive while Swarm has no window on screen at all, and a sheet needs one to hang from.
@MainActor
final class SwarmServicesProvider: NSObject {
