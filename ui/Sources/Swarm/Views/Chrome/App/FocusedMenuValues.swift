...
///
/// `SwarmCommands` is one body, shared by every window and every screen the app has, so an item
...
extension FocusedValues {
    ...
    /// Command-Backspace deletes to the start of the line in every text field on macOS, and Swarm
    /// had given it to Archive Workspace. A user typing a prompt reached for it, and archived the
    /// workspace he was writing in: "in Swarm this triggers a shortcut to delete the workspace".
    ///
