...
/// Command-clicking the title drops down the path from the worktree up to the volume. Swarm's
...
///
/// On Home there is no workspace, so the title says Swarm rather than staying on the last one.
///
