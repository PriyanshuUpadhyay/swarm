...
final class DetailSplitViewController: NSSplitViewController {
    ...
    // The narrowest this half of the window can be drawn is `SwarmApp.widths.detailHalf`, and it
    ...
    private static let autosaveName = "swarm.detail.split"
    ...
    override func viewDidLoad() {
        ...
        // every semantic colour inside the pane then resolves to its vibrant variant. Swarm's
    ...
    private func makeRoomForInspector(animated: Bool) {
        ...
        let fit = SwarmApp.widths.presenting(
...
struct DetailSplitView: NSViewControllerRepresentable {
    ...
    func sizeThatFits(
        ...
        let minimum = SwarmApp.widths.detailHalf(withInspector: isInspectorPresented)
        return CGSize(
