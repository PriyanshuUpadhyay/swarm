...
///
/// Swarm has three independent text sizes: the conversation, which is a named step on a scale of
...
enum TextZoom {
    ...
    private static var focusedTerminal: SwarmTerminalView? { focusedView(SwarmTerminalView.self) }
