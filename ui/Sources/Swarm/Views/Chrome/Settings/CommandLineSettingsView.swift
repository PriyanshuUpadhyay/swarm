...
/// The Command Line pane: coupling a client the owner runs themselves to the Swarm that is
/// running.
///
...
/// Terminal and got an `mcp add` command. Nothing in here is about the terminal Swarm draws; it is
...
struct CommandLineSettingsView: View {
    ...
    ///
    /// Two causes and they are told apart nowhere, on purpose: both mean this copy of Swarm cannot
