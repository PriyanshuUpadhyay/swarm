...
/// behind Swarm's back, and one row per event. Folded into General it would more than double that
...
struct NotificationSettingsView: View {
    ...
    var body: some View {
        ...
        // Revoking the permission happens in System Settings, which means it happens while Swarm is
        // in the background. Coming back is the only moment Swarm gets to notice.
