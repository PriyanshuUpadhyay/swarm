...
struct CenterColumnView: View {
    ...
    nonisolated static let space = "swarm.centreColumn"
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .swarmRenameTab)) { _ in
        ...
        // pulled from a terminal outside Swarm, did not reach the `+` menu, the notices or the quick
