...
/// about in `SwarmAppDelegate.confirmQuit`. It is the same shape here for the same reason.
///
/// WHAT there is to lose is `SwarmCore.SessionClosure` rather than a line of `if` here, because it
