...
final class CenterTabStore {
    ...
    /// their panes anyway: a tmux session whose tab is only on disk is still one Swarm can reach,
    ...
    /// down and nothing under `Sources/Swarm` can be tested. It used to number from the count of
