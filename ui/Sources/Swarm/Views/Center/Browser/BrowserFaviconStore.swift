...
final class BrowserFaviconStore {
    ...
    /// square the page was asked for. Both are impossible from a canvas Swarm sized and both are
    ...
    private static func image(from png: Data) -> NSImage? {
        ...
        // can put something indistinguishable from a control Swarm drew into Swarm's own strip.
