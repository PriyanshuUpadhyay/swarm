...
struct BrowserToolbarView: View {
    ...
    var body: some View {
        ...
        // flat fill, so the material would resolve to a colour Swarm already has a name for, and
    ...
    ///
    /// `Palette.selected` rather than a tint: it is the step of Swarm's ramp meant to sit under
    ...
    /// The dim runs are `textTertiaryOnGlass`, which is Swarm's tertiary in light and AppKit's
