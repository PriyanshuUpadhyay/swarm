...
final class BrowserUIObserver: NSObject, WKUIDelegate {
    ...
    ///
    /// **Nil is returned and a Swarm browser tab is opened instead, which is a decision rather
    ...
    /// The page's origin as a name, which is Swarm's half of anything a page raises. The rule is
