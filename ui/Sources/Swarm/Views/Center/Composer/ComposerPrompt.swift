...
struct ComposerPrompt<Footer: View>: View {
    ...
    /// Opens a slash command's backing file. Conversations use a Swarm file tab; prompts shown
    ...
    var body: some View {
        ...
        // worth re-reading one. A skill written in another window while Swarm stayed open is in
    ...
    private func attachmentFailed(_ message: String) {
        app.alert = SwarmAlert(title: "That file was not attached", message: message)
    }
