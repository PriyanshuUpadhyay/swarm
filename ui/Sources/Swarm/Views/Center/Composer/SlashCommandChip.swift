...
struct SlashCommandChip: View {
    ...
    /// Opens the command's source inside Swarm. The create window has no workspace tabs, so its
    ...
    /// The primary action stays inside Swarm. The context menu still offers external editors for
