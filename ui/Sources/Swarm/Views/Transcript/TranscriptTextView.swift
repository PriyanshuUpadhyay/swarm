...
struct TranscriptLinkActions: Sendable, Equatable {
    ...
    ///
    /// A file, because a chip standing for words Swarm injected has nowhere to go: the words are in
...
struct FileChipHover: Equatable, Sendable {
    /// What the chip stands for: a file, or the words Swarm put in the message. One value rather
...
struct TranscriptTextView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> LinkTextView {
        ...
        // Swarm decides what an address is, in the core, where it is tested. AppKit's own detector
...
final class LinkTextView: NSTextView, HoverQuickLookSource {
    ...
    private static let ownTrackingArea = "swarm.transcriptTextView.tracking"
