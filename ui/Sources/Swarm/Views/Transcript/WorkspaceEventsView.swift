...
/// What Swarm did to this workspace, at the top of its transcript.
///
...
/// One thing Swarm did, on the transcript's columns.
///
...
struct WorkspaceEventRow: View {
    ...
    /// sometimes. At the smallest window Swarm opens, the whole row was about a quarter of the
    /// transcript.
    ///
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            // row a reader who has never used Swarm before most needs.
            if event.kind == .setup {
    ...
    static let endID = "swarm.workspaceEvent.setupEnd"
