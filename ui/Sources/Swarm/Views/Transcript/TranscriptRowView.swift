...
struct TranscriptRowView: View, Equatable {
    ...
    private var content: some View {
        ...
        case .user:
            ...
            //
            // Nothing is taken out for the instructions Swarm appends. They stay in the text and
    ...
    /// A user turn is the line Swarm itself wrote to stdin, so it is read straight out of the
