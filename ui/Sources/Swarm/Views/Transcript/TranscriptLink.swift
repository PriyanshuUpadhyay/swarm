...
enum TranscriptLink {
    ...
    /// message went, and the instructions Swarm appended drawn as that same chip.
    ///
    ...
    ///
    /// A plain click goes to the system's browser. Everywhere in Swarm's own window is only ever
