...
/// really". A chip names a file and the card shows the file. A chip stands for instructions Swarm
...
enum TranscriptHoverCard: Equatable {
    ...
    /// The words a chip stands for when there is no file behind it, which is what Swarm's merge
