...
///
/// `AskUserQuestion` reaches Swarm as a `can_use_tool` control request like any other tool, so
...
/// host will offer an Other row, on the strength of which the asker is told not to write one. Swarm
