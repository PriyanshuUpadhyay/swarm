...
/// said something, or Swarm is reporting what became of it. `CrewMessage` in the core is the
...
///
/// **A fact gets no rule at all.** `.stopped` and `.failed` are Swarm's own voice reporting that a
