...
///
/// Two cases, because a web page is the only tab whose mark is not Swarm's to choose. A
...
///
/// A favicon is content from the page drawn inside Swarm's own chrome, so it is given a box and
