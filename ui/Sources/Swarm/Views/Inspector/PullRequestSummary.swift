...
struct PullRequestSummary: View {
    ...
    ///
    /// Swarm never writes the commit message. The agent knows what it changed and how this project
    /// words a commit; Swarm knows only that a file is dirty, and a message invented from that
