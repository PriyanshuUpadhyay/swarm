...
/// Swarm is open, so a negative answer expires and is asked again rather than disabling GitHub
/// for the rest of the launch. Signing in through Swarm's own sheet does not wait for that: it
