...
/// Which of the applications Swarm knows about are installed.
///
...
enum InstalledApps {
    ...
    /// installing an editor and coming back to Swarm shows it without a relaunch.
    ...
    /// for an application installed behind Swarm's back; an application added in Swarm's own
    ...
    /// entry in that list somebody may have chosen deliberately, so an editor Swarm has never
