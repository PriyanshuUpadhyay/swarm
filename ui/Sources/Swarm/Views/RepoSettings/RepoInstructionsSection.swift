...
/// What this project has to say to the agent, on top of what Swarm says, when Swarm sends a turn
/// of its own.
///
/// Swarm's own words are not here and cannot be edited here, which is the whole shape of the pane.
...
/// resolving a conflict are a file Swarm attaches, `ConflictInstructions`, and they are not
...
/// writes `.swarm/merge-instructions.md` instead, and that file beats this field. The field says
