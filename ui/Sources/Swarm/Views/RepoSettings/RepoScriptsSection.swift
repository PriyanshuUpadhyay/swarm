...
/// The commands this project runs on Swarm's behalf.
///
...
/// file, `.swarm/setup.sh`, and the settings file points at it, so the same program can be linted,
...
///
/// The distinction is the whole point of the field: `.swarm/setup.sh` is a program somebody can
