...
enum TerminalPaneMenu {
    static func make(
        ...
        // `SwarmTerminalView.performKeyEquivalent`, and it is the key the menu bar's Add to Chat
    ...
    ///
    /// The keystroke itself is unaffected either way. It is read in `SwarmTerminalView.keyDown`,
