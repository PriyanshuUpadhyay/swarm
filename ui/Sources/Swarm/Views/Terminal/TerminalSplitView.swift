...
struct TerminalSplitView: View {
    ...
    /// `strip` is the one line above the shell: what this pane was running when Swarm last stopped,
    ...
    /// to fade an unfocused split has said everything Swarm needs to know. Painting the fill at the
