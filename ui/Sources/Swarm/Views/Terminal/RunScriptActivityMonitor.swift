...
///
/// **Two ways to read, because a pane is one of two things.** A shell Swarm forked itself has its
...
final class RunScriptActivityMonitor {
    ...
    /// Swarm typed a command into this pane. Nothing is recorded for a pane nobody polls, which is
