...
/// The one people will actually automate: hand Swarm a project and a sentence, get a workspace.
struct CreateWorkspaceIntent: AppIntent {
    ...
    /// Creating a workspace starts a `claude` process that Swarm has to own for the whole of its
