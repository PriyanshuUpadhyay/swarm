...
/// Looking for the artwork of projects that were added before Swarm knew how to look.
///
...
/// for are never touched, and artwork Swarm found is looked at again only when the file it found
