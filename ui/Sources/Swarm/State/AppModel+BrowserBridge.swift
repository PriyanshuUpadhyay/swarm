...
extension AppModel {
    ...
    func report(_ tab: CenterTab, number: Int, name: String) -> BrowserPaneReport {
        ...
        return BrowserPaneReport(
            ...
            isLive: true,
            // The pane already draws this. Reporting it is what stops a model reading Swarm's own
    ...
    private func perform(
        ...
        case .screenshot:
            // Before the picture, because the picture is Swarm's error card and a card is a
    ...
    private func act(
        ...
        // Nothing to outline, click or read in a pane showing Swarm's own error card.
