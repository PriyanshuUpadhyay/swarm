...
///
/// There are five, and two are not always there. The window used to be one screen that
...
public struct OnboardingFlow: Sendable, Hashable {
    ...
    /// Mac awake" and "Use Bloom from your terminal", on the argument that "Continue" tells nobody
