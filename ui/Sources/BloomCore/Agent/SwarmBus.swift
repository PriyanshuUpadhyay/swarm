...
// The agents Bloom starts through swarm, and the messages it exchanges with them.
//
// Bloom is the chair of every agent it starts (docs/decisions/0007 at the root of the swarm
...
/// Where Bloom starts, reads and talks to swarm agents. The live bus runs the `swarm` CLI; tests
