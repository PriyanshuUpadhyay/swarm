    ...
    var body: some View {
        Group {
            if let workspace = renaming {
                ...
                // Ask Bloom's full pane. There is nothing to rename, so it is text and only text.
                //
                // Home draws no title at all. It said "Bloom", which names the application in its
