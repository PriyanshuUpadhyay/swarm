...
/// at all. `CreateWorkspaceView.load` picks the last project started in, the selected
/// workspace's project, or the first one, or puts up the empty state when there are no projects
/// left to start in.
