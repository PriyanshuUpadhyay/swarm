...
public enum Shell {
    ...
    ///
    /// **Every subprocess in Swarm starts with one of these, and the walk is not cheap.** It
    ...
    /// Swarm to be told about. The one `isExecutableFile` on the remembered path is what makes the
