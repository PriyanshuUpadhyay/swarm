...
///
/// Two facts, because two is all it takes: whether Swarm is the app in front of the user, and
...
/// preference when somebody reports that Swarm went quiet.
...
public enum NotificationPolicy {
    public static func verdict(
        ...
        // while Swarm is the active app, and those are exactly the ones worth saying something
        // about.
