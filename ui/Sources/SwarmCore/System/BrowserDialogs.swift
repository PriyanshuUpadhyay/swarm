...
/// is chrome the reader trusts. A page that writes "Swarm needs your GitHub token" into an alert
/// is doing the oldest trick there is, and the answer every browser reached is the same: Swarm's
...
public struct BrowserDialogs: Sendable, Equatable {
    ...
    public struct Presentation: Sendable, Equatable {
        /// Swarm's own line, naming who is speaking.
    ...
    /// Swarm's own line above the page's words.
    ///
