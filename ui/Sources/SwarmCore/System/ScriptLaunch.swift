...
///
/// Swarm used to have one answer: take the string out of the settings file and hand it to
...
/// honest thing is to honour it: `./.swarm/setup.sh` from a terminal and the same script started
/// by Swarm should be the same program, run by the same interpreter, or the in-app editor is
...
public enum ScriptLaunch: Sendable, Hashable {
    ...
    public static func resolve(
        ...
        if let file {
            ...
            // what Swarm has always done and is still exactly right.
