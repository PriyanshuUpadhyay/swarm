...
public enum BrowserAddress {
    ...
    /// Whether a browser of Swarm's own could show this address at all.
    ///
    ...
    /// The page at this address, as something Swarm may hand to another application on this Mac.
    ///
    ...
    ///
    /// http and https only, which is the same door `shows` opens for a browser pane of Swarm's
