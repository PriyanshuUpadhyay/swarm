...
/// The two things Swarm asks a page about its own icon.
///
...
/// whatever it likes, and the answer ends up drawn inside Swarm's own chrome.
///
/// **The page rasterises, Swarm does not decode.** `image` draws the icon into a canvas Swarm
