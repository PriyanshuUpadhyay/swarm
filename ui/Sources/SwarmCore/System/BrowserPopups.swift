...
/// took the default answer of nil and the click looked broken. Swarm's answer is a second browser
...
public struct BrowserPopups: Sendable, Equatable {
    ...
    /// says what Swarm did rather than what the page did, because "a page tried to" reads as an
