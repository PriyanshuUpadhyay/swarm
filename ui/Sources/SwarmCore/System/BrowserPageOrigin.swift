...
///
/// A page can raise two things that look like they came from Swarm: a file panel, and (once the
/// dialogs land) an alert. Both are chrome the reader trusts, and a page that writes "Swarm needs
...
/// sentence the reader sees says which site asked, in Swarm's words, above whatever the page
/// wrote.
///
...
public enum BrowserPageOrigin {
    ...
    /// serve `/Swarm Support: enter your token/` and have it appear in the sentence), and the
