...
public enum InspectorTab: String, Hashable, CaseIterable, Sendable {
    ...
    /// every check Swarm knows about comes out of the `statusCheckRollup` of a single
    ...
    /// workflow may trigger on `push`, and the day Swarm asks GitHub for those the answer this
