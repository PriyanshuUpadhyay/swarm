...
///
/// It was one line in `SwarmApp`: the sidebar's maximum, plus the detail half's minimum, plus a
...
/// clipped Create Pull Request button that `SwarmApp`'s old comment is about. `presenting` is the
