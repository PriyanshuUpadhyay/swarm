...
/// held per preset, switching from Swarm to Charcoal Glass silently put the conversation back at
...
public struct ThemeOverrides: Codable, Equatable, Sendable {
    ...
    public static func migrating(from defaults: UserDefaults, theme: ColourTheme = .swarm) -> Self {
        var value = Self()
