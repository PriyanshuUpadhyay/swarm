...
///
/// **The bug: switch away from Swarm and back, and the selected workspace turns solid blue.** The
...
/// table is first responder in the key window, and a quiet grey otherwise. Swarm's accent is its
