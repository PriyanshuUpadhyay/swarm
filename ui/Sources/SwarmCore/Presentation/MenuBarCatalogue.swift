...
/// carries.
///
/// **It is the source of truth rather than a description of one.** `SwarmCommands` is a
...
public enum MenuBarCatalogue {
    ...
    public static let commands: [MenuBarItem] = [
        ...
        MenuBarItem(.about, in: .swarm, "About Swarm"),
        ...
        // that appears while Ask Swarm is open, which is a control you have to already be looking
        // at to find: the owner asked whether Swarm could clear an Ask conversation at all, and it
        ...
        // Command-J opens and closes the Ask Swarm panel. It had no key while Ask was a place in the
...
/// The menus Swarm contributes items to.
///
/// Window is not here. Everything in it is SwiftUI's and AppKit's, and the one thing Swarm used to
...
public enum MenuBarAvailability: String, Equatable, Sendable {
    ...
    case needsWorkspace
    /// A workspace or Ask Swarm is selected.
