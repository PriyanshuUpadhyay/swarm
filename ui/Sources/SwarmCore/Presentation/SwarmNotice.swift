...
public struct SwarmNotice: Identifiable, Equatable, Sendable {
...
/// Swarm did, and why it could not do the rest of it. Drawn at one size they are a paragraph in a
