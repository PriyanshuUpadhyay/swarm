...
/// is called if the content it was named after has left. `Tests/SwarmCoreTests` cannot see
/// `Sources/Swarm`, so a tab that quietly dissolved when it should have been re-filed is a bug
