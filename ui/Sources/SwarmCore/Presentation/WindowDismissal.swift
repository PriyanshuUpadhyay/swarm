...
///
/// **The bug this is written from.** Swarm's Cmd+W is Close Session, and that item sits in the
...
///
/// **Why a role rather than a list of windows.** Escape means something inside most of Swarm's
