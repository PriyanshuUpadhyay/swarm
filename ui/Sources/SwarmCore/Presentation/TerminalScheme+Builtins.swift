extension TerminalScheme {
    ...
    public static let swarm = builtin(id: "swarm", title: "Swarm", background: PaletteInk.surfaceSunken)
    ...
    ///
    /// Red, yellow and blue are Swarm's, so a failing test's red in the terminal is the same red
