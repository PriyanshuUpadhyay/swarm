...
/// nothing is happening.** That is what put Swarm under "Using Significant Energy" in the battery
...
/// only thing that can move the count is the user editing files outside Swarm, and a minute-old
