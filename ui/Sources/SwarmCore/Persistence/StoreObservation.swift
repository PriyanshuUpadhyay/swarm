...
/// update hook is per connection and Swarm opens the same file twice: the app's `Store` and
...
/// hub extends that to every connection in this process, and no further. Swarm and Swarm Dev are
