...
/// Everything that decides whether Swarm may rename the branch it cut a few seconds ago.
///
...
public struct BranchRenameFacts: Sendable, Hashable {
    ...
    /// Swarm or GitHub knows of a pull request for this branch.
...
public enum BranchRenameRefusal: Sendable, Hashable {
    ...
    /// thought: "Swarm named this workspace Dark mode toggle. The branch is still
