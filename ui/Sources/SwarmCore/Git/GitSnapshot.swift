...
public struct GitSnapshot: Codable, Sendable, Equatable {
    ...
    public var worktreeRef: String { "refs/swarm/checkpoints/\(id)/worktree" }
    public var indexRef: String { "refs/swarm/checkpoints/\(id)/index" }
    public var rawIndexRef: String { "refs/swarm/checkpoints/\(id)/raw-index" }
