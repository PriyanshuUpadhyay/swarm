...
/// What a directory Swarm recorded turns out to be, asked once something has already failed in it.
///
...
public enum CheckoutStanding: Sendable, Equatable {
    /// Nothing at the path at all. Deleted, moved or renamed since Swarm wrote it down.
    case missing
    ...
    /// git's complaint without the command line Swarm built to provoke it.
    ///
