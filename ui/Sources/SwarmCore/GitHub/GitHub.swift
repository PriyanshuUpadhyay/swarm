...
public enum GitHub {
    ...
    /// `refs/pull/N/head`, and finds it. That is the only route that works for a fork, and Swarm
...
public extension GitHub {
    ...
    /// Somebody who clones over SSH everywhere should not get one HTTPS remote from Swarm.
