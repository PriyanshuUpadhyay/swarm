...
/// string the C library itself printed rather than by anything Swarm guessed:
///
...
public struct SetupDiagnosis: Sendable, Hashable {
    ...
    /// What the script exited with, when Swarm watched the run. Nil for a workspace reopened long
