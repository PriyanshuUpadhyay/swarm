...
extension WorkspaceManager {
    ...
    /// Applies a suggestion to a workspace that is still wearing the placeholder Swarm gave it.
    ///
    ...
    ///
    /// - Parameter placeholder: the exact name Swarm wrote at creation. The rename is abandoned
