...
/// /Users/…/workspaces/swarm-git-711961F7…/do-thing main` exited 128: fatal: invalid reference:
...
/// inside Swarm's own worktree root.
public enum WorkspaceStartTrouble: Sendable, Equatable {
    /// The project is not where Swarm recorded it. Nothing the agent does will fix this.
