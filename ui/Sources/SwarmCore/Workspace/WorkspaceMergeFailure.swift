...
/// reason is the whole point of this tool existing: Swarm hands a merge to the workspace's own
...
///
/// Every sentence says whether retrying helps, names no path inside Swarm's own worktree root, and
/// quotes no command line Swarm built.
