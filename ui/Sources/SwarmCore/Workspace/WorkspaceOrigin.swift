...
///
/// A workspace an agent asked for is an ordinary Swarm workspace with an ordinary agent in it.
...
public enum WorkspaceOrigin: Sendable, Equatable, Hashable, Codable {
    ...
    public init(parentWorkspaceID: String?, spawnToolUseID: String?) {
        ...
        // of Swarm that did not know about the second column, or by hand. It reads as the owner's,
