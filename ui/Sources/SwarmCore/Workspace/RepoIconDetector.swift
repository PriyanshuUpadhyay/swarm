...
public enum RepoIconDetector {
    ...
    /// about what Swarm can and cannot reproduce of it, is on `RepoIconFile.layers(ofIconBundle:)`.
    ...
    ///
    /// The question a stored answer asks of the folder it came out of: is the file Swarm picked
...
public enum RepoIconFormat: String, Sendable, Hashable, Codable, CaseIterable {
    ...
    /// is vector inside, but Swarm has to compose it itself without the system's glass, shadow and
