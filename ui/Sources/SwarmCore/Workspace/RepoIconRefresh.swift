...
/// front of it: "is this a folder Swarm is allowed to go and look at again". They are separate
...
///
/// `.detected` is Swarm's own guess and is therefore the one that could be revisited, but a
