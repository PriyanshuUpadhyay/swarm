...
///
/// Every agent in Swarm is working for the same person, in workspaces that person opened or let an
/// agent open, and the message is delivered by Swarm rather than relayed by something outside it.
