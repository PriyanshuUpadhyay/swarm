...
/// the same `TmuxSessions.fingerprint`, so Swarm and Swarm Dev can never land on one socket. That
...
public enum BridgeSocketPath {
    ...
    public static func derive(
        ...
        let name = "swarm-bridge-" + TmuxSessions.fingerprint(databasePath) + ".sock"
