...
/// `project_add`: registering a git repository that already exists as a Swarm project.
///
...
/// rather than to hope. Swarm has a whole sheet for turning a folder into a repository, with the
...
/// refused one of Swarm's own worktrees and a home directory that happened to be a repository,
