...
public enum BridgeRole: String, Sendable, Hashable, Codable, CaseIterable {
    ...
    /// session, no worktree and no project behind it. It is the person, reaching Swarm from a
    /// `claude` they started themselves in a terminal, with Swarm registered in their own MCP
    /// configuration, or Ask Swarm inside the app.
    ///
