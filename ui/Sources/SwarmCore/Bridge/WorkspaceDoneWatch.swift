...
/// workspace the same problem was solved by making the end of a subagent's turn an event Swarm
/// delivers; see `Crew.stoppedSentence`. This is that, one workspace further out.
///
/// ## Why a row rather than a flag in memory
///
/// The other turn can run for twenty minutes, and the owner can quit Swarm in the middle of it. A
...
/// What Swarm does with one watch after one ending.
