...
///
///     "command": "/Users/freek/Applications/Swarm.app/Contents/MacOS/swarm-bridge"
///
...
/// - Its `SWARM_UI_BRIDGE_SOCKET` and `SWARM_UI_BRIDGE_TOKEN` are **exactly what this instance would
...
/// - Its `command` names a file called `swarm-bridge`. Belt and braces over the pair above, and it
...
///   environment, so a Swarm Dev shim driving the release copy's socket is a working arrangement,
...
public enum BridgeUserRegistrationRepair {
    ...
    public enum Reason: String, Sendable, Hashable {
        ...
        case alreadyCorrect
        /// Pointing somewhere else, at a `swarm-bridge` that is still there. Not stale, so not
    ...
    ///   - attachment: what this copy of Swarm would hand out today.
    ...
    static let shimName = "swarm-bridge"
