...
/// without it Swarm would be taken down by an agent CLI exiting mid-call. With it the write
...
public final class UnixSocketConnection: Sendable {
    ...
    ///
    /// No retry and no wait. The ordinary reason this fails is that Swarm has quit and somebody is
    ...
    /// when it cannot say. The shim for a connection Swarm accepted. See `BridgeOwnerPlacement`.
