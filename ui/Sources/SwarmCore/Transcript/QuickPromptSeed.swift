...
/// The quick prompts a fresh copy of Swarm starts with, and the rule that stops a deleted one from
/// coming back.
///
...
/// back again?" with "because Swarm puts it there every time you start it". Instead each built-in
...
public enum QuickPromptSeed {
    ...
    public static let all: [Entry] = [
        // The one Swarm ships with. It is deletable, like everything else here, and deleting it
