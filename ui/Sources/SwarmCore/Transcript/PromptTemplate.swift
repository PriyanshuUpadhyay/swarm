...
/// template. A name Swarm has never heard of is almost always a typo, and it is handed back in the
/// text so the mistake is visible in the transcript rather than swallowed. A name Swarm knows but
