...
/// An image format a pasteboard can hand over, in the order Swarm would rather have it.
///
...
///
/// Pure, and in SwarmCore, because this is the part of pasting that is a decision rather than a
...
public enum PastedAttachment {
    ...
    public enum Plan: Sendable, Equatable {
        ...
        case images([Image])
        /// None of Swarm's business. The text system pastes it, exactly as it always has.
        case text
    }
    ...
    /// one of those is better than the same bytes rewritten under a name Swarm invented. This is
