...
/// What a session Swarm was writing to turns out to be, asked once a write has already failed.
///
...
public enum TranscriptStanding: Sendable, Equatable {
    ...
    /// The database's complaint without the statement Swarm built to provoke it.
    ///
