...
/// moments, not because Swarm wanted the variety. Measured off a real 66 line capture in which
...
public struct SubagentStart: Sendable, Hashable {
    ...
    /// nested transcript rows Swarm already indents behind a hairline, and `tool_progress`, which
