...
///
///     Attached file:
///     - .swarm/attachments/9JVKW4/IMG_4395.jpeg
///
/// The part that has not changed is the path. Every agent Swarm can run reads files by path, so a
...
///
/// Swarm does not draw it as a list either, and a list of paths in a speech bubble was a worse
