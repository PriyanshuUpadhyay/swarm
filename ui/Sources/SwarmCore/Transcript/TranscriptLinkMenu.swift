...
public enum TranscriptLinkTarget: Sendable, Hashable {
    ...
    /// A browser tab in Swarm's own centre column.
    case browserTab
...
/// condition it had, whether Swarm's browser could show the address at all, was a closure the view
...
public enum TranscriptLinkMenu {
    ...
    /// nothing of Swarm's own, it is what a plain click already does, and an address refused
    ...
    public static func items(
        ...
        // Everything below opens a browser of Swarm's own, so everything below needs an address
