...
///      ACP holds the prompt request open until the turn ends. Swarm therefore must not wait on
    ...
    public func start() async throws {
        ...
        let result = try await send(
            ...
            params: .object([
                ...
                // Empty on purpose. Advertising `fs` or `terminal` makes the agent ask Swarm to
