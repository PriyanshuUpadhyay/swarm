...
public struct AgentQuestion: Sendable, Hashable, Identifiable {
    ...
    static func decode(_ json: JSONValue) -> AgentQuestion? {
        ...
        return AgentQuestion(
            ...
            answerID: json["swarmAnswerID"]?.stringValue,
            allowsOther: json["swarmAllowsOther"]?.boolValue ?? true,
...
public enum AgentQuestionnaire {
    ...
    /// provides one. Swarm is the host, so Swarm provides it: without it a question whose options
