...
/// in a worktree. Ask Swarm is not. `permission_grants.repo_id` is `NOT NULL REFERENCES repos(id)`,
...
public struct PermissionScopeOffer: Sendable, Hashable {
    ...
    ///   Swarm, and it is the whole reason this takes an optional rather than a name and a flag: a
