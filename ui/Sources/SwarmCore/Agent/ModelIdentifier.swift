...
/// runs it.
///
/// Model ids are an open set, and deliberately so. One reaches Swarm verbatim from places Swarm
...
/// names a backend Swarm actually has.
///
...
public struct ModelIdentifier: Equatable, Sendable {
    ...
    /// The three spellings of a backend a file could reasonably use: the key Swarm stores, the
