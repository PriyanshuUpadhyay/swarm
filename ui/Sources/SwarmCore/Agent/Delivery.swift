...
///
/// **This is the `deliveries` queue in `swarm-handover/mcp-design.md`, not a second one beside
...
/// for the rows Swarm draws about a workspace. It becomes a `messages` row at the moment it goes,
...
public struct Delivery: Identifiable, Sendable, Hashable {
    ...
    /// A delivery of something one agent said to another, or of Swarm's word about one of them.
    ///
