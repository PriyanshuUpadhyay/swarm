...
public struct ComposerControls: Equatable, Sendable {
    ...
    /// Whether this chat has a worktree behind it. False is Ask Swarm, and it is here rather than
    ...
    /// Every other chat in Swarm is in a worktree, which is a copy of a project cut for the
