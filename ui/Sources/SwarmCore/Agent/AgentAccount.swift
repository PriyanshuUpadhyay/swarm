...
///
/// Both CLIs already send all of this in the answers Swarm asks for, and Swarm used to read it and
...
public enum AgentAccountReader {
    ...
    /// as Max: a name Swarm would have to guess the rest of is a name it does not print.
