...
/// and every decision in it inside the app target, where `Tests/SwarmCoreTests` cannot reach.
...
public enum ToolTint: String, Sendable, Hashable, CaseIterable {
    ...
    case neutral
    /// It is Swarm's own doing, or a search this window will show the results of.
    case accent
