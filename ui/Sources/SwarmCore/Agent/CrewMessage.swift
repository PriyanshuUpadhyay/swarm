...
public struct CrewMessage: Sendable, Equatable, Codable {
    ...
    public enum Event: String, Sendable, Codable {
        ...
        case said
        /// Swarm reporting that an agent's turn ended. Not an agent talking.
        case stopped
        /// Swarm reporting that an agent did not finish.
        case failed
        /// An agent in another workspace said something to this one, through `workspace_say`.
        case relayed
        /// Swarm reporting that the owner cancelled a message this agent sent another workspace.
        case cancelled
        /// Swarm reporting that the turn a `workspace_say` or `workspace_start` asked to hear
    ...
    /// Who is speaking, which is what the rule down the left is coloured by. A fact is Swarm's own
    ...
    /// Swarm telling an orchestrator that one of its subagents has stopped, carrying what that
    ...
    public static func stopped(name: String, lastMessage: String?) -> CrewMessage {
        ...
        return CrewMessage(
            event: .stopped, sender: .swarm, from: name,
    ...
    public static func failed(name: String, reason: String) -> CrewMessage {
        ...
        return CrewMessage(
            event: .failed, sender: .swarm, from: name,
    ...
    public static func cancelled(to workspace: String, text: String) -> CrewMessage {
        ...
        return CrewMessage(
            event: .cancelled, sender: .swarm, from: workspace,
