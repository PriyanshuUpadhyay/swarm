...
/// Swarm only reads the payload so it can print a plan and an email address.
...
public actor AgentCatalog {
    ...
    ///
    /// The file is a map of issuer keys to credential objects. Swarm reads only the non-secret
