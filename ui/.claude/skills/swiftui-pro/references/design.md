...
Reuse the typography, colours, dimensions and animation values in `Sources/Swarm/Design`.
...
- Use `Label`, hierarchical foreground styles and `LabeledContent` where they fit. Preserve
  Swarm's established custom empty states when they provide useful guidance.
