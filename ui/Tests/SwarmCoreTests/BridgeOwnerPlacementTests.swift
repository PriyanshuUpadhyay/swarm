...
struct BridgeOwnerPlacementTests {
    private let repo = Repo(name: "swarm", path: "/Users/someone/code/swarm")

    private func workspace(_ name: String, at path: String, archived: Bool = false) -> Workspace {
        var workspace = Workspace(
            repoID: repo.id, name: name, branch: "swarm/\(name)", path: path, baseBranch: "main"
        )
    ...
    private var live: [Workspace] {
        [
            workspace("bothnian-sea", at: "/Users/someone/swarm/workspaces/bothnian-sea"),
            workspace("baltic", at: "/Users/someone/swarm/workspaces/baltic/"),
        ]
    }

    @Test("a directory inside a live workspace is refused, and the sentence names the workspace", arguments: [
        "/Users/someone/swarm/workspaces/bothnian-sea/Sources/SwarmCore",
        "/Users/someone/swarm/workspaces/bothnian-sea",
        "/Users/someone/swarm/workspaces/bothnian-sea/",
        "/Users/someone/swarm/workspaces/bothnian-sea/./Tests",
    ])
    func insideIsRefused(_ directory: String) throws {
        ...
        #expect(refusal.contains("/Users/someone/swarm/workspaces/bothnian-sea"))
    ...
    func trailingSlashOnTheRow() throws {
        let refusal = BridgeOwnerPlacement.refusal(
            workingDirectory: "/Users/someone/swarm/workspaces/baltic", workspaces: live
        )
        #expect(try #require(refusal).contains("'baltic'"))
        #expect(BridgeOwnerPlacement.refusal(
            workingDirectory: "/Users/someone/swarm/workspaces/baltic/src", workspaces: live
        ) != nil)
    }

    @Test("a directory in no workspace is let through", arguments: [
        // A sibling whose name only begins with a workspace's.
        "/Users/someone/swarm/workspaces/bothnian-sea-2",
        "/Users/someone/swarm/workspaces/balticsea/src",
        // The directory holding the workspaces, and one above it.
        "/Users/someone/swarm/workspaces",
        "/Users/someone",
        // Where Ask Swarm's shim runs, which really is the owner.
    ...
    func archivedIsIgnored() {
        let archived = [workspace("old", at: "/Users/someone/swarm/workspaces/old", archived: true)]
        #expect(BridgeOwnerPlacement.refusal(
            workingDirectory: "/Users/someone/swarm/workspaces/old/src", workspaces: archived
        ) == nil)
    }
