...
struct AgentStartSourceTests {
    ...
    /// a prefix Swarm strips everywhere else would be refusing the right branch.
    ...
    /// Git allows one worktree per branch, so this is a refusal Swarm can make in words instead of
