...
struct RunScriptNoticeTests {
    ...
    private let file = "/Users/someone/code/maintainly/.swarm/settings.toml"
    ...
    func oneIssue() throws {
        ...
        #expect(notice.title == "1 entry in .swarm/settings.toml was skipped")
    ...
    func severalIssues() throws {
        ...
        let notice = try #require(SettingsIssuesNotice.make(issues: issues))
        #expect(notice.title == "4 entries in .swarm/settings.toml were skipped")
    ...
    func unreadableFile() throws {
        ...
        let notice = try #require(SettingsIssuesNotice.make(issues: issues))
        #expect(notice.title == ".swarm/settings.toml could not be read")
    }
