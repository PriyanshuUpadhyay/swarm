...
/// replacement: it is a folder Swarm made, there is nothing in it, and it is nowhere under `~`.
...
struct AgentScratchDirectoryTests {
    ...
    @Test("it is a folder of Swarm's own, beside whatever it was given")
    func pathIsInsideTheBase() {
        #expect(AgentScratchDirectory.path(in: "/somewhere") == "/somewhere/swarm-agent-scratch")
    }
