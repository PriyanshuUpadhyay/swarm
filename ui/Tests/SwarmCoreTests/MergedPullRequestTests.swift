...
/// A pull request that has been merged and had its branch deleted, which is the state Swarm's own
...
/// went on both sides. Swarm's band went on showing it as open and ready to merge, with eighteen
/// checks passed and a live Squash and merge button, for the rest of the launch. GitHub had
/// already landed it.
///
/// Measured in that worktree, running exactly what Swarm runs:
///
