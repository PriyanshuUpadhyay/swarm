...
/// Stands in for `codex app-server`. It reads the frames Swarm writes, answers requests from a
...
final class ScriptedCodexProcess: AgentProcessing, @unchecked Sendable {
    ...
    /// The methods Swarm sent, in order, requests and notifications alike.
