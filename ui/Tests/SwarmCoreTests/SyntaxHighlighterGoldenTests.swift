...
5|plain:    |operator:<|type:title|operator:>|type:Swarm|operator:</|type:title|operator:>
...
== json
0|punctuation:{
1|plain:  |string:"name"|punctuation::|plain: |string:"swarm"|punctuation:,
...
2|
3|comment:# a comment
4|type:NAME|operator:=|string:"|variable:${1:-swarm}|string:"
...
5|plain:  |keyword:and|plain: |plain:t|punctuation:.|plain:name|plain: |keyword:like|plain: |string:'%swarm%'
...
2|attribute:name|plain: |operator:=|plain: |string:"swarm"
...
7|keyword:const|plain: |plain:name|plain: |operator:=|plain: |function:ref|punctuation:(|string:'swarm'|punctuation:);
...
5|plain:    |operator:<|type:string|operator:>|type:Swarm|operator:</|type:string|operator:>
6|plain:  |operator:</|type:dict|operator:>
7|operator:</|type:plist|operator:>
== yaml
0|comment:# a comment
1|attribute:name|punctuation::|plain: |plain:swarm
