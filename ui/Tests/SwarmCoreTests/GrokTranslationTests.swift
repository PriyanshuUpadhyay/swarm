...
struct GrokTranslationTests {
    ...
    @Test("a tool call maps onto Read and carries the path Swarm already looks for")
    ...
    @Test("permission options map allow_once onto Swarm's once")
    ...
    @Test("reject_always without allow_always does not offer Swarm's persistent grant")
