...
struct TranscriptLinkMenuTests {
    ...
    @Test("An address no browser of Swarm's own could show offers only the external browser",
...
/// The one rule about what a browser of Swarm's own can be pointed at, which `BrowserTab.canOpen`
