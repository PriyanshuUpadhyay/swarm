...
struct FolderVerdictTests {
    private func facts(
        ...
        FolderFacts(
            ...
            workspacesRoot: "/Users/tester/swarm/workspaces",
    ...
    func repositoryDoesNotWin() {
        ...
        let worktree = facts("/Users/tester/swarm/workspaces/kelp", isRepository: true)
        #expect(FolderVerdict.of(worktree)
            == .refuse(.insideSwarmsWorkspaces("/Users/tester/swarm/workspaces/kelp")))
    }
    ...
    func prefixIsNotContainment() {
        let sibling = facts("/Users/tester/swarm/workspaces-old/kelp", isRepository: true)

        #expect(FolderVerdict.of(sibling)
            == .alreadyRepository(root: "/Users/tester/swarm/workspaces-old/kelp"))
    }
}
...
struct FolderRefusalAgentSentenceTests {
    ...
    @Test("the refusals a repository can land on name the alternative", arguments: [
        FolderRefusal.insideSwarmsWorkspaces("/Users/tester/swarm/workspaces/kelp"),
        .homeDirectory,
        .volumeRoot,
    ])
...
struct GitHubRepositoryNameTests {
    @Test("accepts the names GitHub accepts", arguments: [
        "baton", "Swarm", "laravel-medialibrary", "under_score", "dot.name", "v2.0", "a", "123",
        ".github",
    ])
