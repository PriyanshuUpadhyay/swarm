...
struct FileMentionTests {
    ...
    @Test("an address is not a file", arguments: [
        "https://github.com/spatie/swarm",
        "http://localhost:3000/index.html",
        "github.com/spatie/swarm",
    ])
    ...
    @Test("the turn Swarm sends to open a pull request draws its path as a file")
    func splitsThePullRequestTurn() {
        ...
        #expect(FileMention.segments(in: text) == [
            ...
            .attachment(".swarm/scratch/pr-instructions.md"),
            .text("."),
        ])
    }
