...
/// The attachment trailer is the one place in Swarm where prose is parsed, and it is parsed out of
...
struct AttachmentTrailerTests {
    ...
    func composesSingular() {
        let text = AttachmentTrailer.compose(text: "look at this", paths: [".swarm/a/IMG.jpeg"])
    ...
    func roundTrips() {
        let cases: [(String, [String])] = [
            ("look at this", [".swarm/attachments/9JVKW4/IMG_4395.jpeg"]),
    ...
    func keepsNamesWithSpaces() {
        let path = ".swarm/attachments/aB3xY9/CleanShot 2026-08-19 at 00.04.38@2x.jpg"
