...
@Suite struct CodexClientTests {
    ...
    @Test func sendsATurnWithItsOwnModelAndEffort() async throws {
        ...
        // An attachment is a path, which is exactly what Swarm's composer already produces.
    ...
    /// The half a plain NDJSON reader cannot do: the server asks, and Swarm answers.
    @Test func answersAnApprovalTheServerAsked() async throws {
        ...
        let ask = try swarmFixtureLines("codex-approval.ndjson").first { line in
