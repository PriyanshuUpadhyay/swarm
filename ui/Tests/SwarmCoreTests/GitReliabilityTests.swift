...
struct GitReliabilityTests {
    ...
    func metadataWatchRoots() async throws {
        ...
        let ignored = WorktreeWatcher.metadataWorktrees(changed: [
            ...
            WorktreeWatcher.resolve(first.commonDirectory) + "/refs/swarm/checkpoints/turn/worktree",
            WorktreeWatcher.resolve(first.commonDirectory) + "/logs/refs/swarm/checkpoints/turn/worktree",
            WorktreeWatcher.resolve(first.gitDirectory) + "/swarm-snapshot-turn-index",
            WorktreeWatcher.resolve(first.gitDirectory) + "/swarm-restore-temporary",
        ], metadata: metadata)
