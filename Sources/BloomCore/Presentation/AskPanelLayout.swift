...
/// How big the Ask Bloom panel is, the order its conversations are listed in, and the mark each
/// one wears.
///
/// # Why Ask Bloom is a panel
///
/// It was a destination: a second row under Home at the top of the sidebar, selecting it swapped
/// the centre column for the conversation. The owner's words were that "Home / Ask Bloom" spent
